...
> 本文档定义了 AI Agent（如 Claude、GPT-4、Gemini 等）与项目维护者的协作方式、工作流程和交互原则
...
9. **docs/PATTERN_INTEGRATION_GUIDE.md**
   - Pattern 集成标准化流程
   - 从独立项目到主项目的完整指南
   - 文档编写规范和测试清单
...
**更新历史**:
- v0.3.0 (2025-12-03): 更新为模型无关的 AI Agent 指南，兼容所有 LLM
